...
public class GeneratePDF {
    public static void processPDF(String path, String applicant, String applicantId){
...
//                PDPage page = doc.getPage(i);
                ...
                if ((int)dataCor[3]!=0){
                    ...
                    generateQr("temp\\qr\\qr.png",timeNow,"Muhammad Farras Ma'ruf",applicant,applicantId);
...
//                    contents.drawImage(pdImage2,0,0,100,100);
    ...
    public static void generateQr(String path, String time, String approver, String aplicant, String apllicantId) {
        Map<String, String> dataJson = new HashMap<>();
        dataJson.put("status", "Disetujui pada tingkat pertama");
        dataJson.put("waktu", time);
        dataJson.put("oleh", approver);
        dataJson.put("nama_pengaju", aplicant);
        dataJson.put("id_pengaju", apllicantId);

//        String data ="{\"status\":\"disetuji pada tingkat pertama\", \"waktu\":\""+time+"\", \"oleh\":\""+approver+"\",\"nama_pengaju\":\""+aplicant+"\",\"id_pengaju\":\""+apllicantId+"\"}";
        String data = new JSONObject(dataJson).toString();
